...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="/res/meta/bootstrap.min.css"
      crossorigin="anonymous"
    />

    <!-- Bootstrap JS -->
    <script
      src="/res/meta/jquery-3.5.1.min.js"
      crossorigin="anonymous"
    ></script>
    <script
      src="/res/meta/popper.min.js"
      crossorigin="anonymous"
    ></script>
    <script
      src="/res/meta/bootstrap.min.js"
      crossorigin="anonymous"
    ></script>

    <link
      rel="stylesheet"
      href="/res/meta/Style.css"
    />
  ...
  <body>
          ...
          <div class="col-lg-4 col-md-8 col-sm-12 vertical-center">
            <div class="card">
              <div class="card-body" id="loginbody">
                <div class="">
                  <img
                    src="/res/meta/emblem-logo-dark.png"
                    class="img-fluid center-img"
                    alt="Logo"
                  />
                  <div class="logoText">Metadata and Phone Manager</div>
                </div>
                <form
                  class="loginForm"
                  method="post"
              ...
              %>
                <div id="form-error">
                  ...
                  <span class="errorBox">
                  <%
                    String strMsg = "Invalid login or password.";
                    out.write(strMsg);
                  %>
                  </span>
                </div>
              <% } %>
               <div class="form-group form-group-position">
                    <input
                      id="login" name="login"
                      type="text"
                      class="form-control" value="<%= DomUtil.escapeXmlString(strLogin) %>"
                      required
                    />
                  ...
                  <br />
				   <div class="form-group">
                    <center>
                      <a
                        id="forgotPassword"
                        href="/meta/forgotPassword.jssp">Forgot your password?</a>
                    </center>
                  </div>
              </form>
            </div>
    ...
    <script src="/res/meta/Index.js"></script>
    <script type="text/javascript">
      $(document).ready(function () {
        $("#login").blur(function () {
          if ($(this).val().length === 0) {
            var trigger = "manual";
            var placement = "right";
            var content = "Please enter a valid username.";
            var template =
              '<div class="popover"><div class="arrow"></div><div class="popover-inner"><div class="popover-content"><p><img src="/res/meta/WarningIcon.png" alt="WarningIcon">&nbsp;&nbsp;<em>Please enter username.</em></p></div></div></div>';
            popover(
              $("#login").attr("id"),
              trigger,
              placement,
        ...
        $("#password").blur(function () {
          if ($(this).val().length === 0) {
            var trigger = "manual";
            var placement = "right";
            var content = "Please enter password.";
            var template =
              '<div class="popover"><div class="arrow"></div><div class="popover-inner"><div class="popover-content"><p><img src="/res/meta/WarningIcon.png" alt="WarningIcon">&nbsp;&nbsp;<em>Please enter a valid password.</em></p></div></div></div>';
            popover(
              $("#password").attr("id"),
              trigger,
              placement,
