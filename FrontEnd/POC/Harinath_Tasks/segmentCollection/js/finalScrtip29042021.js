$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (i = 0; i < getSegmentListLength; i++) {
                    ...
                    // $('#createSegmentLanguage').append(' <select id="seglanguage_' + i + '"><option id="0">Select Language*</option><option id="1">Language 1</option><option id="2">Language 2</option><option id="3">Language 3</option><option id="4">Language 4</option><option id="5">Language 5</option><option id="6">Language 6</option></select>');
                    ...
                    $("#seglanguage_" + i).change(function () {
                        ...
                        //  segLangAsgValue = {
                        //     "segmentLanguageId":getSelectedOptionData
                        // }
                        // console.log(arrayPushSegmentLanguageID);
                        // console.log(segLangAsgValue);
                        // console.log(arrayMultipleSegmentNames);
    ...
    $("#tab5_Next").click(function () {
        ...
        var segmentAssignPhoneJSON = {
            "segmentId": createSegmentRequest.segment_collection[0].data.segmentId,
        ...
        var createPhoneLangJSON = {
            "createSegment": createTouchRequest.data.haveSegments,
            "createPhoneNumber": createTouchRequest.data.havePhoneAssignements,
            "segmentsAssignment": []
        };

        console.log(segmentAssignPhoneJSON);

        Object.assign(createSegmentRequest.segment_collection[0].segmentAssignment_collection.data, createPhoneLangJSON);
        // console.log(createSegmentRequest.segment_collection[0].segmentAssignment_collection);
        // console.log(createSegmentRequest);


        createSegmentRequest.segment_collection[0].segmentAssignment_collection.data.segmentsAssignment.push(segmentAssignPhoneJSON);
        // console.log(createSegmentRequest.segment_collection[0].segmentAssignment_collection);
        console.log(createSegmentRequest);
